...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        ...
        strPriority = input('What is ' + strTask + ' Priority? [low|high]: ')
    ...
    def remove_data_from_list(task, list_of_rows):
        strTask = input('What task did you complete?: ')
        for dicRow in lstTable:
            if dicRow['Task'].lower() == strTask.lower():
                lstTable.remove(dicRow)
                print(strTask, 'has been successfully removed')
        else:
            print('That task ' + strTask + ' is not on the list')
        return list_of_rows, 'Success'
